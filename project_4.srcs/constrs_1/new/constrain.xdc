...
set_property IOSTANDARD LVCMOS33 [get_ports switch_P]
set_property PACKAGE_PIN N4 [get_ports switch_P]




set_property IOSTANDARD LVCMOS33 [get_ports light_on]
set_property IOSTANDARD LVCMOS33 [get_ports opening]
set_property IOSTANDARD LVCMOS33 [get_ports reminder]
set_property PACKAGE_PIN K2 [get_ports light_on]
set_property PACKAGE_PIN J2 [get_ports opening]
set_property PACKAGE_PIN J3 [get_ports reminder]

set_property IOSTANDARD LVCMOS33 [get_ports wave_out]
set_property PACKAGE_PIN T1 [get_ports wave_out]
set_property IOSTANDARD LVCMOS33 [get_ports en]
set_property PACKAGE_PIN M6 [get_ports en]